            ...
            <div class="col-md-8 no-padding">
                <div class="visible-lg">
                    <ul id="hornavmenu" class="nav navbar-nav">
                        <li>
                            <a href="index.html" class="fa-home <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>2</b><br />
">Home</a>
                        </li>
                        <li>
                                        <span class="fa-gears <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>3</b><br />
">Features</span>
                            <ul>
                                <li class="parent">
                        ...
                        <li>
                                        <span class="fa-copy <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>36</b><br />
">Pages</span>
                            <ul>
                                <li>
                        ...
                        <li>
                                        <span class="fa-th <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>50</b><br />
">Portfolio</span>
                            <ul>
                                <li>
                        ...
                        <li>
                                        <span class="fa-font <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>58</b><br />
">Blog</span>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a href="contact.html" class="fa-comment <br />
<b>Notice</b>:  Undefined variable: page in <b>C:\xampp\htdocs\bootstrap\html\php\top-menu.php</b> on line <b>64</b><br />
">Contact</a>
                        </li>
                    </ul>
                </div>
